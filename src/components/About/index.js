    ...
    <section className="bg-light variant-light p-5" id="about">
      <Container className="text-center">
        ...
        <div className="my-2 p-3">
          ...
          <span>
            <h2>Tool Kit</h2>
            <p>HTML5, CSS, JavaScript-ES6, MVC, OOP ▪ Express, Node, React, React-Router, Handlebars ▪ SQLite, MySQL, GraphQL, Sequelize, MongoDB, Mongoose, PWAs ▪ Bootstrap, Bulma, Tailwind CSS, JQuery, Python, VBA</p>
          </span>
        </div>
      </Container>
    </section>
